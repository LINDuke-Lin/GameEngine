...
using GameEngine.Lib.Skills.Interfaces;

namespace GameEngine.Lib.Skills
{
    public class StrAttack : ISkill
    {
        ...
        {
            //是否被迴避
            return Convert.ToInt32(userAbility.Accuracy).IsDodge(Convert.ToInt32(othersAbility.Agility));
        }
        /// <summary>
        /// 使用技能
        /// 傷害 : 基礎攻擊力 + 物理攻擊
